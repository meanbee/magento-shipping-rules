<?php
class Meanbee_Shippingrules_Test_Model_Rule_Condition_Cart_Total extends EcomDev_PHPUnit_Test_Case {
    /** @var Meanbee_Shippingrules_Model_Rule_Condition_Cart_Total */
    protected $_obj = null;

    public function setUp() {
        $this->_obj = Mage::getModel('meanship/rule_condition_cart_total');
    }
    ...
    public function testModelConstructed() {
        $this->assertInstanceOf('Meanbee_Shippingrules_Model_Rule_Condition_Cart_Total', $this->_obj);
    }
