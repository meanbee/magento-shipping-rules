<?php
class Meanbee_Shippingrules_Test_Model_Rule_Condition_Customer_Group extends EcomDev_PHPUnit_Test_Case {
    /** @var Meanbee_Shippingrules_Model_Rule_Condition_Customer_Group */
    protected $_obj = null;

    public function setUp() {
        $this->_obj = Mage::getModel('meanship/rule_condition_customer_group');
    }
    ...
    public function testModelConstructed() {
        $this->assertInstanceOf('Meanbee_Shippingrules_Model_Rule_Condition_Customer_Group', $this->_obj);
    }
