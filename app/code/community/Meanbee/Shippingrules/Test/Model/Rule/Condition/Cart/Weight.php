<?php
class Meanbee_Shippingrules_Test_Model_Rule_Condition_Cart_Weight extends EcomDev_PHPUnit_Test_Case {
    /** @var Meanbee_Shippingrules_Model_Rule_Condition_Cart_Weight */
    protected $_obj = null;

    public function setUp() {
        $this->_obj = Mage::getModel('meanship/rule_condition_cart_weight');
    }
    ...
    public function testModelConstructed() {
        $this->assertInstanceOf('Meanbee_Shippingrules_Model_Rule_Condition_Cart_Weight', $this->_obj);
    }
