<?php
class Meanbee_Shippingrules_Test_Model_Rule_Condition_Product_Category extends EcomDev_PHPUnit_Test_Case {
    /** @var Meanbee_Shippingrules_Model_Rule_Condition_Product_Category */
    protected $_obj = null;

    public function setUp() {
        $this->_obj = Mage::getModel('meanship/rule_condition_product_category');
    }
    ...
    public function testModelConstructed() {
        $this->assertInstanceOf('Meanbee_Shippingrules_Model_Rule_Condition_Product_Category', $this->_obj);
    }
