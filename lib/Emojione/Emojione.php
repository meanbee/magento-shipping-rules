...
class Emojione_Emojione
{
    ...
    public static function getClient()
    {
        ...
        {
            static::setClient(new Emojione_Client);
        }
     ...
     * @return void
     */
    public static function setClient(Emojione_ClientInterface $client)
    {
        // DEPRECATED
     ...
     * @return self
     */
    protected static function loadConfig(Emojione_ClientInterface $client)
    {
     ...
     * @return self
     */
    protected static function updateConfig(Enojione_ClientInterface $client)
    {
