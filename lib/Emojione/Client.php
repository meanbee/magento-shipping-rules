...
class Emojione_Client implements Emojione_ClientInterface
{
    ...
    public $imagePathPNG = '/skin/adminhtml/default/default/lib/emojione/png/';
    public $imagePathSVG = '/skin/adminhtml/default/default/lib/emojione/svg/';
    public $imagePathSVGSprites = '/skin/adminhtml/default/default/lib/emojione/sprites/emojione.sprites.svg';
     ...
     * Get the Ruleset
     *
     * @return Emojione_RulesetInterface The Ruleset
     */
    public function getRuleset()
    {
        if ( $this->ruleset === null )
        {
            $this->ruleset = new Emojione_Ruleset;
        }
