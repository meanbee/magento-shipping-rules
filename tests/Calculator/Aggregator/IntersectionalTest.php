<?php
class Calculator_Aggregator_IntersectionalTest extends PHPUnit_Framework_TestCase
{
    /** @var Meanbee_Shippingrules_Calculator_Registers */
    private $registers;

    /** @var Meanbee_Shippingrules_Calculator_Aggregator_Intersectional */
    private $aggregator;
    ...
    public function setUp()
    {
        ...
        $this->aggregator = new Meanbee_Shippingrules_Calculator_Aggregator_Intersectional($this->registers);
