<?php
class Calculator_Comparator_LessThanTest extends PHPUnit_Framework_TestCase
{
    /** @var Meanbee_Shippingrules_Calculator_Registers */
    private $registers;

    /** @var Meanbee_Shippingrules_Calculator_Comparator_LessThan */
    private $comparator;
    ...
    public function setUp()
    {
        ...
        $this->comparator = new Meanbee_Shippingrules_Calculator_Comparator_LessThan($this->registers);
    }
    ...
    {
        $this->assertEquals(get_class($this->registers->getComparatorRegister()->get('lessthan')), get_class($this->comparator));
    }
