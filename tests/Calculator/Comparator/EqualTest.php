<?php
class Calculator_Comparator_EqualTest extends PHPUnit_Framework_TestCase
{
    /** @var Meanbee_Shippingrules_Calculator_Registers */
    private $registers;

    /** @var Meanbee_Shippingrules_Calculator_Comparator_Equal */
    private $comparator;
    ...
    public function setUp()
    {
        ...
        $this->comparator = new Meanbee_Shippingrules_Calculator_Comparator_Equal($this->registers);
    }
    ...
    {
        $this->assertEquals(get_class($this->registers->getComparatorRegister()->get('equal')), get_class($this->comparator));
    }
    ...
    public function testNumber()
    {
        ...
        $this->assertFalse($this->comparator->evaluate(4/3, 1.33333333334, 'number'));
    }
    ...
    public function testNumberBase26()
    {
        ...
        $this->assertFalse($this->comparator->evaluate('0123456789KLMNOPQRSTUVWXYZ', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'number_base26'));
        $this->assertFalse($this->comparator->evaluate('0123456789KLMNOPQRSTUVWXYZ', '0123456789KLMNOPQRSTUVWXYZ', 'number_base26'));
        $this->assertFalse($this->comparator->evaluate('?', '?', 'number_base26'));
    }
    ...
    public function testNumberBase36()
    {
        ...
        $this->assertFalse($this->comparator->evaluate('01YZ', 'ABYZ', 'number_base36'));
    }

    public function testString()
    {
        $this->assertTrue($this->comparator->evaluate('same', 'same', 'string'));
        $this->assertFalse($this->comparator->evaluate('same', 'different', 'string'));
